...
function _get_code_message($code) {
    $code_msgs = array(
        '000' => 'AUTHORIZED EMV StatusCode: Transaction completed successfully',
        ...
        '200' => 'Canceled by merchant',
        '201' => 'Cancelled by kiplepark,repeated entry/failed gen ticket id/season pass user',
        '203' => 'Canceled after remove card',
        '300' => 'Canceled accepted',
        '500' => 'Server online',
